...
filedump_path = os.environ["stock_etf_base"]
filedump_path = "/Users/alexfiner/Desktop/streamlit_final/files"

if not os.path.exists(filedump_path): os.makedirs(filedump_path)

def savefile(data, benchmark, filename):
    if not isinstance(benchmark, type(None)):
        ...
        df.to_csv(os.path.join(filedump_path, filename))
    else:
        data.to_csv(os.path.join(filedump_path, filename))
...
def snapshot(returns, grayscale=False, figsize=(10, 8),
    ...
    savefile(returns, None, "snapshot.csv")
...
def earnings(returns, start_balance=1e5, mode="comp",
    ...
    savefile(returns, None, "earnings.csv")
...
def returns(returns, benchmark=None,
    ...
    savefile(returns, benchmark, "returns.csv")
...
def log_returns(returns, benchmark=None,
    ...
    savefile(returns, benchmark, "log_returns.csv")
...
def daily_returns(returns,
    ...
    savefile(returns, None, "daily_returns.csv")
...
def yearly_returns(returns, benchmark=None,
    ...
    savefile(returns, benchmark, "yearly_returns.csv")
...
def distribution(returns, fontname='Arial', grayscale=False, ylabel=True,
    ...
    savefile(returns, None, "distribution.csv")
...
def histogram(returns, resample='M', fontname='Arial',
    ...
    savefile(returns, None, "histogram.csv")
...
def drawdown(returns, grayscale=False, figsize=(10, 5),
    ...
    savefile(returns, None, "drawdown.csv")
...
def drawdowns_periods(returns, periods=5, lw=1.5, log_scale=False,
    ...
    savefile(returns, None, "drawdowns_periods.csv")
...
def rolling_beta(returns, benchmark,
    ...
    savefile(returns, None,  "rolling_beta.csv")
...
def rolling_volatility(returns, benchmark=None,
    ...
    savefile(returns, benchmark, "rolling_volatility.csv")
...
def rolling_sharpe(returns, benchmark=None, rf=0.,
    ...
    savefile(returns, benchmark, "rolling_sharpe.csv")
...
def rolling_sortino(returns, benchmark=None, rf=0.,
    ...
    savefile(returns, benchmark, "rolling_sortino.csv")
